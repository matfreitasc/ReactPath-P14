							...
							'string' === L.type(m.mask) &&
								...
								O.on('keydown.xdsoft', function (e) {
									...
									if ((48 <= n && n <= 57) || (96 <= n && n <= 105) || 8 === n || 46 === n) {
										for (
											t = 8 === n || 46 === n ? '_' : String.fromCharCode(96 <= n && n <= 105 ? n - 48 : n),
												8 === n && r && !i && (r -= 1);
											;
					...
					F.find('.xdsoft_select')
						...
						(_.setOptions = function (e) {
							...
							(N = L.extend(!0, {}, N, e)),
								...
								N.minDate &&
									/^[\+\-](.*)$/.test(N.minDate) &&
									(N.minDate = E.formatDate(W.strToDateTime(N.minDate), N.formatDate)),
								N.maxDate &&
									/^[\+\-](.*)$/.test(N.maxDate) &&
									(N.maxDate = E.formatDate(W.strToDateTime(N.maxDate), N.formatDate)),
								N.minDateTime &&
									/^\+(.*)$/.test(N.minDateTime) &&
							...
							(r.now = function (e) {
								...
								(r.nextMonth = function () {
									...
									return (
										...
										r.currentTime.setDate(
											Math.min(new Date(r.currentTime.getFullYear(), t + 1, 0).getDate(), r.currentTime.getDate())
										),
								...
								(r.prevMonth = function () {
									...
									return (
										...
										r.currentTime.setDate(
											Math.min(new Date(r.currentTime.getFullYear(), e + 1, 0).getDate(), r.currentTime.getDate())
										),
								...
								(t = setTimeout(function () {
									...
									for (
										l += '</tr></thead>',
											...
											!1 !== N.minDate &&
												((g = W.strToDate(N.minDate)), (g = new Date(g.getFullYear(), g.getMonth(), g.getDate()))),
											!1 !== N.minDateTime &&
								...
								N.fixed
									...
									: ((i = !1),
									  h(t, function (e) {
											return (
												null !== e &&
												('fixed' === N.contentWindow.getComputedStyle(e).getPropertyValue('position') ? !(i = !0) : void 0)
											);
									  }),
									  i && !N.insideParent
							...
							switch (H) {
								...
								case 'reset':
									(this.value = this.defaultValue),
										(this.value && e.data('xdsoft_datetime').isValidDate(E.parseDate(this.value, N.format))) ||
											e.data('changed', !1),
